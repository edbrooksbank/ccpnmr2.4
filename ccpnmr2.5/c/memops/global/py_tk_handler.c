...
py_tk_handler.c: Part of the CcpNmr Analysis program
...
Bool is_py_tk_handler(PyObject *obj)
{
/*  below does not work because different *.so files end up
    with different addresses for Tk_handler_type
    return (obj->ob_type == &Tk_handler_type);
*/
    return valid_py_object(obj, &Tk_handler_type);
}
...
static PyObject *resize(PyObject *self, PyObject *args)
{
    ...
    resize_tk_handler(tk_handler, w, h);
...
static PyObject *expose(PyObject *self, PyObject *args)
{
    ...
    expose_tk_handler(tk_handler, x, y, w, h);
...
static PyObject *mapRanges(PyObject *self, PyObject *args)
{
    ...
    map_ranges_tk_handler(tk_handler, x0, y0, x1, y1, a0, b0, a1, b1);
...
static PyObject *makeCurrent(PyObject *self, PyObject *args)
{
    ...
    return Py_BuildValue("i", (int) make_current_tk_handler(tk_handler));
}
...
static PyObject *drawDashBox(PyObject *self, PyObject *args)
{
    ...
    draw_dash_box_tk_handler(tk_handler, x0, y0, x1, y1);
...
static PyObject *drawXorBox(PyObject *self, PyObject *args)
{
    ...
    draw_xor_box_tk_handler(tk_handler, x0, y0, x1, y1);
...
static PyObject *resetXor(PyObject *self, PyObject *args)
{
    ...
    reset_xor_tk_handler(tk_handler);
...
static PyObject *endBack(PyObject *self, PyObject *args)
{
    ...
    end_back_tk_handler(tk_handler);
...
static PyObject *setBackground(PyObject *self, PyObject *args)
{
    ...
    set_background_tk_handler(tk_handler, background);
...
static PyObject *drawText(PyObject *self, PyObject *args)
{
    ...
    draw_text_tk_handler(tk_handler, text, x, y, a, b);
...
static PyObject *drawDashLine(PyObject *self, PyObject *args)
{
    ...
    draw_dash_line_tk_handler(tk_handler, x0, y0, x1, y1, dash_length, gap_length);
...
static PyObject *setBlack(PyObject *self, PyObject *args)
{
    ...
    set_black_tk_handler(tk_handler);
...
static PyObject *setWhite(PyObject *self, PyObject *args)
{
    ...
    set_white_tk_handler(tk_handler);
...
static PyObject *setLineWidth(PyObject *self, PyObject *args)
{
    ...
    set_line_width_tk_handler(tk_handler, line_width);
...
static PyObject *resetLineWidth(PyObject *self, PyObject *args)
{
    ...
    reset_line_width_tk_handler(tk_handler);
...
static PyObject *setFont(PyObject *self, PyObject *args)
{
    ...
    if (set_font_tk_handler(tk_handler, name, size) == CCPN_ERROR)
...
static PyObject *getRegion(PyObject *self, PyObject *args)
{
    ...
    get_region_tk_handler(tk_handler, &x0, &y0, &x1, &y1);
...
static PyObject *setIsDoubleBuffer(PyObject *self, PyObject *args)
{
    ...
    set_is_double_buffer_tk_handler(tk_handler, is_double_buffer);
...
static PyObject *new_py_tk_handler(PyObject *widget)
{
    Py_Tk_handler obj;
...
*/
	...
	RETURN_OBJ_ERROR("allocating Py_Tk_handler object");
    }

    obj->tk_handler = tk_handler;

    return (PyObject *) obj;
}

static void delete_py_tk_handler(PyObject *self)
{
    Py_Tk_handler obj = (Py_Tk_handler) self;
    Tk_handler tk_handler = obj->tk_handler;
...
/*
static int print_py_tk_handler(PyObject *self, FILE *fp, int flags)
{
...
static PySequenceMethods Tk_handler_sequence_methods =
{
    Tk_handler_length,
    Tk_handler_concat,
    Tk_handler_repeat,
...
static PyObject *init_Py_Tk_handler(PyObject *self, PyObject *args)
{
    PyObject *widget;
    ...
    return new_py_tk_handler(widget);
}
...
static struct PyMethodDef Tk_handler_type_methods[] =
{
    { "TkHandler",	(PyCFunction) init_Py_Tk_handler,	METH_VARARGS },
    { NULL,		NULL,			0 }
};
...
*
* Initialization function for the module. Called on first "import TkHandler" in 
* a Python program. The function is usually called "initTk_handler": this name's
